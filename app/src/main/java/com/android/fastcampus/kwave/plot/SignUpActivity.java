...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        signUpProfile = (EditText) findViewById(R.id.signUpProfile);
    ...
    /* 버튼을 눌렀을 때 동작하는 소스 */
        ...
        profile = signUpProfile.getText().toString();
